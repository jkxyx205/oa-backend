...
public class WorkspaceController {
    ...
    public Result trash(@PathVariable CategoryEnum category, @PathVariable Integer id) {
    ...
    public Result inbox(@PathVariable CategoryEnum category, @PathVariable Integer id) {
    ...
    public Result archive(@PathVariable CategoryEnum category, @PathVariable Integer id) {
    ...
    public Result clean(@PathVariable CategoryEnum category, @PathVariable Integer id) {
    ...
    public Result follow(@PathVariable CategoryEnum category, @PathVariable Integer id) {
    ...
    public Result unfollow(@PathVariable CategoryEnum category, @PathVariable Integer id) {
    ...
    public Result unread(@PathVariable CategoryEnum category, @PathVariable Integer id) {
